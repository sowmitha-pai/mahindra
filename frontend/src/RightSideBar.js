...
let mm_2020=0,mm_2021=0,mm_2022=0,mar_2020=0,mar_2021=0,mar_2022=0,tata_2020=0,tata_2021=0,tata_2022=0
let sales=0,rev=0,cont=0;
const RightSideBar = ({updateSelectedCompany}) => {
 ...
 item["all_data_iter_4.date_year"] === 2020).map((item,index)=>{
   switch(item["all_data_iter_4.company"]){
     case "Mahindra":
       mm_2020=item["all_data_iter_4.total_revenue"].toFixed(2)
       break
       case "Maruthi":
         mar_2020=item["all_data_iter_4.total_revenue"].toFixed(2)
         break
         case "Tata":
           tata_2020=item["all_data_iter_4.total_revenue"].toFixed(2)
           break
   }
 }
)
linegraphdata.filter((item) =>
 item["all_data_iter_4.date_year"] === 2021).map((item,index)=>{
   switch(item["all_data_iter_4.company"]){
     case "Mahindra":
       mm_2021=item["all_data_iter_4.total_revenue"].toFixed(2)
       break
       case "Maruthi":
         mar_2021=item["all_data_iter_4.total_revenue"].toFixed(2)
         break
         case "Tata":
           tata_2021=item["all_data_iter_4.total_revenue"].toFixed(2)
           break
   }
 }
)
linegraphdata.filter((item) =>
 item["all_data_iter_4.date_year"] === 2022).map((item,index)=>{
   switch(item["all_data_iter_4.company"]){
     case "Mahindra":
       mm_2022=item["all_data_iter_4.total_revenue"].toFixed(2)
       break
       case "Maruthi":
         mar_2022=item["all_data_iter_4.total_revenue"].toFixed(2)
         break
         case "Tata":
           tata_2022=item["all_data_iter_4.total_revenue"].toFixed(2)
           break
   }
 }
)
   ...
   <>
     <div className="rightsidebar">
       <div className="rightbar__topcontainer">
         ...
         <div className="radiobutton">
           <div className="first-line">
             <input onChange={selectCompanyHandler}
               type="radio"
               id="mahindra"
               name="brand_name"
               value="Mahindra"
         ...
         <div className="rightbarbottomcontainer">
           ...
           <div className="rightbarbottom__options">
             <div className="options1container">
               <select name="vehiles" id="vehicle" onChange={onVehicleHandler}>
                 <option value="Petrol">Petrol</option>
                 <option value="Diesel">Diesel</option>
           ...
           <div className="data">
             <div className="datafirst-line">
              {
                salesdata.filter((item)=>item["all_data_iter_4.date_year"] === parseInt(selectedYear) && item["all_data_iter_4.fuel_type"]==selectedVehicle && item["all_data_iter_4.zone"]==selectedZone).map((item, index) => {
                  switch(item["all_data_iter_4.date_year"]){
                    case 2022:
                      sales=item["all_data_iter_4.total_revenue"].toFixed(2)
                      rev=mm_2022
                      cont=(sales/rev*100).toFixed(2)
                      break
                    case 2021:
                      sales=item["all_data_iter_4.total_revenue"].toFixed(2)
                      rev=mm_2021
