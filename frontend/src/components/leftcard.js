...
xuv700_sale=parseInt(xuv700_rev/mah_rev*100)
  ...
  return (
    ...
    <div style={{padding:'10px'}}>
      ...
      <div style={{marginBottom:'1rem', fontSize:'20px', fontWeight:'500'}}>Total sales</div>
          <div style={{marginBottom:'1rem',fontSize:'30px', fontWeight:'600'}}>{mah_rev} Cr</div>
      ...
      <div style={{display:"flex"}}>
        <div style={{flex:1}}>
        <div style={{fontSize:'16px', fontWeight:'400', color:'grey', }}>Total Qty</div>
        <div style={{marginTop:'5px'}}>{mah_ts} Vehicles</div>
        </div>
     <div style={{flex:1}}>
     <div style={{fontSize:'16px', fontWeight:'400', color:'grey' }}>Profit</div>
     <div style={{marginTop:'5px'}}>{mah_profit} Cr</div>
     </div>
      ...
      >
        <div style={{padding:'10px',}}>
          <div style={{backgroundColor: "white", padding:'10px', borderRadius:'10px', width:'350px'}}>
        <div
          style={{
            display: "flex",
        ...
        >
          <span style={{display:"flex",alignItems:"center",fontSize:'18px'}}>Product sale</span>
          <span style={{display:"flex",alignItems:"center"}}><div><FilterAltOutlinedIcon /></div><div>filter</div></span>
        </div>
        <div
          style={{
        ...
        >
           ...
           <span style={{ width: "5px", height: "20px", backgroundColor: "orange", display: "inline-block" }}></span>
           
           

          <span style = {{ color:"gray",fontSize:'16px'}}>Thar</span>
          <span style ={{fontSize:'16px', fontWeight:'800', color:'black'}}>{thar_rev} Cr</span>
        ...
        >
          <span style={{ width: "5px", height: "20px", backgroundColor: "red", display: "inline-block" }}></span>
          <span style = {{ color:"gray",fontSize:'16px'}}>XUV700</span>
          <span  style ={{fontSize:'16px', fontWeight:'800', color:'black'}}>{xuv700_rev} Cr</span>
        ...
        >
          <span style={{ width: "5px", height: "20px", backgroundColor: "skyblue", display: "inline-block" }}></span>
          <span style = {{ color:"gray",fontSize:'16px'}}>XUV300</span>
          <span  style ={{fontSize:'16px', fontWeight:'800', color:'black'}}>{xuv300_rev}Cr</span>
        ...
        >
          <span style={{ width: "5px", height: "20px", backgroundColor: "purple", display: "inline-block" }}></span>
          <span style = {{ color:"gray",fontSize:'16px'}}>Bolero</span>
          <span  style ={{fontSize:'16px', fontWeight:'800', color:'black'}}>{bolero_rev}Cr</span>
        ...
        >
          <span style={{ width: "5px", height: "20px", backgroundColor: "green", display: "inline-block" }}></span>
          <span style = {{ color:"gray",fontSize:'16px'}}>Scorpio</span>
          <span  style ={{fontSize:'16px', fontWeight:'800', color:'black'}}>{scorpio_rev} Cr</span>
        ...
        >
          ...
          <div style={{ backgroundColor: '#4A0404', height: '10px', borderRadius:'10px', width:'10px',marginRight:'10px',marginTop:'4px'}}></div>
            <div style={{ fontSize:'16px' }}>Thar</div>
          </div>
          <div style={{flex:1,display:'flex', marginTop:'20px'}}>
          <div style={{ backgroundColor: '#770737', height: '10px', borderRadius:'10px', width:'10px',marginRight:'10px',marginTop:'4px'}}></div>
                      <div style={{ fontSize:'16px' }}>Scorpio</div>
            </div>
          <div style={{flex:1,display:'flex', marginTop:'20px'}}>
          <div style={{ backgroundColor: '#E0115F', height: '10px', borderRadius:'10px', width:'10px',marginRight:'10px',marginTop:'4px'}}></div>
                  <div style={{ fontSize:'16px' }}>Scorpio</div>
           </div>
          </div>
          <div
        ...
        >
          <div style={{flex:1,display:'flex', marginTop:'20px'}}>
          <div style={{ backgroundColor: '#E30B5C', height: '10px', borderRadius:'10px', width:'10px',marginRight:'10px',marginTop:'4px'}}></div>
            <div style={{ fontSize:'16px', }}>Thar</div>
          </div>
          <div style={{flex:1,display:'flex', marginTop:'20px'}}>
          <div style={{ backgroundColor: '#E30B5C', height: '10px', borderRadius:'10px', width:'10px',marginRight:'10px',marginTop:'4px'}}></div>
